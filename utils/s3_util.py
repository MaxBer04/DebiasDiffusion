...
def main():
    ...
    parser.add_argument('--dataset_dir', default="/root/DebiasDiffusion/data", help='Directory containing the dataset')
    parser.add_argument('--compressed_file', default='final_data', help='Name of the compressed file')

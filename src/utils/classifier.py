...
class GenderClassifier(nn.Module):
    def __init__(self, in_channels, image_size, out_channels, prefix=None):
        super().__init__()
...
def make_classifier_model(in_channels, image_size, out_channels, prefix="train", model_type="linear"):
